create_trax_labels <- function(
  ...
  labels = c(
    ...
    # scid_admin_reason="If no, please give reason", # nolint: commented_code_linter
    ...
    # scid_fu_interviewer_diag1="Interviewers Diagnosis 1", # nolint: commented_code_linter
    # scid_fu_interviewer_diag2="Interviewers Diagnosis 2", # nolint: commented_code_linter
    # scid_fu_interviewer_diag3="Interviewers Diagnosis 3", # nolint: commented_code_linter
    # scid_fu_interviewer_diag4="Interviewers Diagnosis 4", # nolint: commented_code_linter
    # scid_fu_interviewer_diag5="Interviewers Diagnosis 5", # nolint: commented_code_linter
    # scid_fu_interviewer_diag6="Interviewers Diagnosis 6", # nolint: commented_code_linter
