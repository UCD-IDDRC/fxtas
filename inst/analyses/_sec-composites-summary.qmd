...
We created a composite variable named "autoimmune diagnoses or symptoms" combining
...
(details in Supplementary material, Autoimmune diagnoses or symptoms).
...
(more details in Supplementary material, SCID composite variables).
...
(details in Supplementary material, MRI variables).
...
Supplementary Tables [-@supptbl-fxtas-stage-by-cgg] - [-@supptbl-autoimmune]
