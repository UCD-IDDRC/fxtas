...
These findings are summarized in @tbl-critical-findings.
...
depressive and anxiety disorders (and other psychiatric illnesses)
...
(as measured by 
the BDS-2 total score 
and 
the CANTAB SWM instrument, 
respectively).
...
[
@apartis2012fxtas;
@RenaudMathilde2015Rocc;
@HallDeborahA.2017TCCS
] 

{{< include _sec-disc-stress-precip.qmd >}}

{{< include _sec_disc_splenium_cc_sign.qmd >}}

This suggests that the diagnostic criteria for FXTAS
may need to be altered in females compared to males,
