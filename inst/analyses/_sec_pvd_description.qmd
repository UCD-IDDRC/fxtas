...
The heatmap colors (red, blue, magenta, orange, purple)
...
to highlight which symptoms occur in different FXTAS stages 
between the two subgroups 
(i.e., which symptom lines cross one or more stage lines).
