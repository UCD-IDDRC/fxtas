...
abstract_text <- paste0(
  ...
  "Female premutation carriers developed mood disorder symptoms prior to FXTAS", 
  " Stage 1 diagnosis, whereas male carriers experienced these symptoms much",
  " later (after FXTAS Stage 4)"
)
