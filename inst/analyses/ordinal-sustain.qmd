...
if (FALSE) {
  rcartocolor::carto_pal(name = "Safe") |> colorblindcheck::palette_plot()
...
abstract_text <- paste0(
  "The Ordinal Subtype and Stage Inference (SuStaIn) algorithm allows us to ", 
  "estimate the order of symptoms in ",
...
abstract_text <- paste0(
  "Female premutation carriers developed mood disorder symptoms prior to FXTAS Stage 1 diagnosis, whereas male carriers experienced these symptoms much later (after FXTAS Stage 4)"
)
