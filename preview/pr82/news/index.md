...
- added red reference line at 3 obs per stage in
  [`stage_barplot()`](https://UCD-IDDRC.github.io/fxtas/preview/pr82/reference/stage_barplot.md)
  ([\#91](https://github.com/ucd-iddrc/fxtas/issues/91))
- added grayscale legend to PVDs
  ([\#83](https://github.com/ucd-iddrc/fxtas/issues/83))
- added test for
  [`pvd_lineplot()`](https://UCD-IDDRC.github.io/fxtas/preview/pr82/reference/pvd_lineplot.md)
  ([\#68](https://github.com/ucd-iddrc/fxtas/issues/68))
- added `biomarker_order` argument to
  [`compact_pvd_data_prep()`](https://UCD-IDDRC.github.io/fxtas/preview/pr82/reference/compact_pvd_data_prep.md)
  (default behavior should be unchanged)
- added
  [`shared_flextable_settings()`](https://UCD-IDDRC.github.io/fxtas/preview/pr82/reference/shared_flextable_settings.md)
...
- added test for
  [`compile_biomarker_group_list()`](https://UCD-IDDRC.github.io/fxtas/preview/pr82/reference/compile_biomarker_group_list.md)
