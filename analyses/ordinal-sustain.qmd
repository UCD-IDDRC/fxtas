...
results_v1.1 <- extract_results_from_pickle(
  use_rds = use_rds,
  n_s = 1,
...
([Supplementary Fig. @suppfig-cvic-1]). 
...
We labeled the subtypes in descending order of mean CGG; 
Individuals with higher CGG repeats
were over-represented in Subtype 1
(CGG repeat size mean = 
`r cgg_by_subtype["Type 1", "mean"]` ± `r cgg_by_subtype["Type 1", "sd"]`)
compared to the overall study population 
(CGG repeat size mean = `r cgg_overall$mean`  ± `r cgg_overall$sd`) 
and other subtypes.
Subtype 2 had CGG repeat sizes close to the overall study population 
(`r cgg_by_subtype["Type 2", "mean"]` ± `r cgg_by_subtype["Type 2", "sd"]`).
Subtype 3 had lower CGG repeat sizes than the overall study population
(`r cgg_by_subtype["Type 3", "mean"]` ± `r cgg_by_subtype["Type 3", "sd"]`).
and 
Subtype 4 had the lowest CGG repeat sizes
