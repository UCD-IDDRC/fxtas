...
results_cv_max00 <- extract_results_from_pickle(
  n_s = n_s_selected,
  use_rds = use_rds,
  dataset_name = dataset_name,
  output_folder = output_folder,
...
```{r}
figs <- results_cv_max |> 
  plot_positional_var(subtype_order = NULL)
# figs |> 
...
two known risk factors of FXTAS,
sex and CGG repeat size, 
were contributors to the segregation of subtypes 
and variations between subtypes.
Females and individuals with higher CGG repeats
were over-represented in Subtype 1
(65.1% males; CGG repeat size (83.2 ± 15.8)
compared to the overall study population 
(64.5% of males; CGG repeat size mean = 87.3  ± 18.9) and other subtypes; 
