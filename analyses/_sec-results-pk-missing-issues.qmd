...
Out of `r n_pf_screened_cases` premutation carriers 
who were screened for parkinsonian features,
...
(`r pd_count_male` male and `r pd_count_female` female)
were diagnosed with Parkinson's disease
by the participants' primary care physicians or neurologists,
...
All nine participants with recorded Parkinson's disease diagnoses
also had parkinsonian features recorded.
