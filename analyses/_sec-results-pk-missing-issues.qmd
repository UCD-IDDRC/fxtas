...
parkinsons_female_mean <- 
  mean(v1_usable_females$Parkinsons == "Yes", na.rm = TRUE)

parkinsons_female_pct <- 
  round(parkinsons_female_mean * 100, 1)

pf_female_mean <- 
  mean(v1_usable_females$`parkinsonian features` == "Yes", na.rm = TRUE)
...
`r parkinsons_female_pct`% of female participants 
had Parkinsons Disease,
whereas only `r pf_female_pct`% of female participants had parkinsonian features
