...
We limited the estimated probability of correct scoring to `r max_prob_correct *100`%
in order to allow for a plausible probability of elevated symptom levels unrelated to FXTAS progression.
