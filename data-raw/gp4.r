...
labels = c(subj_id = "FXS ID",
           ...
           new_mds_neu_atax = "gait ataxia hx",
           new_mds_neu_atax_age = "gait ataxia age of onset hx",
           new_mds_ne_ga = "gait ataxia exam",
           new_mds_ne_gas = "gait ataxia severity exam",
...
# labels
{
  ...
  # label(dataset$new_mds_neu_atax)="gait ataxia hx"
