...
dataset=vroom::vroom(
  'inst/extdata/fxtas/GPGenotypePhenotypeR-FXTASEventSequence10_DATA_2025-03-14_2119.csv',
  col_types = gp3_cols
)
...
levels(dataset$mds_ne_tand)=c("Normal","Abnormal (<10 steps)","Unable (Absent)","No Response (999)","Question not asked at time of data entry; check records (777)")
...
compare_names_and_labels(names(dataset), gp3_labels)

names(dataset) = gp3_labels[names(dataset)]
