...
label(data$mds_neu_atax_age) <- "gait ataxia age of onset hx"
label(data$mds_neu_atax_sev) <- "gait ataxia severity hx"
...
label(data$new_mds_ne_ga) <- "gait ataxia exam"
...
label(data$new_mds_neu_atax) <- "gait ataxia hx"
